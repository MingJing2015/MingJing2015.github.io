...
var routes = [
    ...
    { path: 'cart/:goods_id/:goods_name/:shop_price', component: _views_cart_cart_component__WEBPACK_IMPORTED_MODULE_6__["CartComponent"] },
    ...
    { path: 'goods', component: _views_type_page_type_page_component__WEBPACK_IMPORTED_MODULE_5__["TypePageComponent"] }
];
...
/*!******************************************!*\
  !*** ./src/app/dataClass/defineClass.ts ***!
  \******************************************/
/*! exports provided: Category, MenuItem, Hero, Teacher, Goods, CartItem, OrdInfo, OrdGoods, NetState_Result, AccountState_Result, Transaction_Result, Student, Transaction, Unlock, PwdChangeStatusModel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.getItems_O = function () {
        var _this = this;
...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.getOrdInforItems = function () {
        ...
        return this.http.get(this.ordInforUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (ordInfos) { return _this.log("fetched OrdInfos"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('getOrdInforItems', [])));
    };
   ...
   */
    ...
    OrderService.prototype.create_OrdInforItem = function (item) {
        var _this = this;
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _dataClass_defineClass__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../dataClass/defineClass */ "./src/app/dataClass/defineClass.ts");
...
/* harmony import */ var _services_remote_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/remote.service */ "./src/app/services/remote.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CartComponent = /** @class */ (function () {
    function CartComponent(cartService, orderService, goodsService, remoteService, route, 
    ...
    CartComponent.prototype.ngOnInit = function () {
        ...
        this.cartItem = new _dataClass_defineClass__WEBPACK_IMPORTED_MODULE_3__["CartItem"](-1, 4, 'iPhone 6s88', 621.34, 2);
        ...
        this.sub = this.route.params.subscribe(function (params) {
            ...
            console.log("ID: " + _this.cartItem.id);
            // For test : 
            ...
            _this.findOneItemAfterGetAll(_this.cartItem);
            // For get Max ID
            _this.getOrder();
            // For get Max ID
            _this.getOrdGoods();
    ...
    CartComponent.prototype.getCartItems = function () {
        ...
        this.cartService.getItems_O()
            .subscribe(function (goodsArray) { return _this.cartItems = goodsArray; });
    };
    CartComponent.prototype.getCartItems_P = function () {
        var _this = this;
        return this.cartService.getItems_P()
            .then(function (cartItems) { return _this.cartItems = cartItems; });
    };
    CartComponent.prototype.getCartItemByID = function (id) {
        var _this = this;
        this.cartService.getItem_O(id)
            .subscribe(function (good) { return _this.cartItem = good; });
    };
    // Do in Array -- useless !
  ...
  */
    ...
    CartComponent.prototype.deleteOne = function (item) {
        ...
        this.cartService
            .deleteItem_O(item)
            .subscribe(function () { _this.cartItems = _this.cartItems.filter(function (h) { return h !== item; }); });
    };
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _dataClass_defineClass__WEBPACK_IMPORTED_MODULE_3__["Goods"])
    ], CartComponent.prototype, "goods", void 0);
    CartComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_cart_service__WEBPACK_IMPORTED_MODULE_5__["CartService"],
            ...
            _services_remote_service__WEBPACK_IMPORTED_MODULE_7__["RemoteService"],
...
module.exports = "<nav class=\"navbar navbar-default\">\n        <div class=\"container\">\n            <div class=\"navbar-header\">\n                <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#bs-example-navbar-collapse-1\"\n                    aria-expanded=\"false\">\n                    <span class=\"sr-only\">Toggle navigation</span>\n                    <span class=\"icon-bar\"></span>\n                    <span class=\"icon-bar\"></span>\n                    <span class=\"icon-bar\"></span>\n                </button>\n                <a class=\"navbar-brand\" href=\"#\">\n                        <img alt=\"Nebulas\" src=\"assets/imgs/icon_19.png\"></a>  \n                <a class=\"navbar-brand\" href=\"#\">NAS Shop</a>\n    \n                <!--\n            <a class=\"navbar-brand\" href=\"#\">\n              <img alt=\"Ming\" src=\"./app/imgs/436631.jpg\">\n            </a>\n    \n            -->\n            </div>\n    <!--\n            <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-1\">\n                <ul class=\"nav navbar-nav\">\n                    <li>\n                        <a routerLink=\"/type-page/type-page/11\" routerLinkActive=\"active fluffy\">\n                            <span class=\"glyphicon glyphicon-screenshot\"></span> Shopping</a>\n                    </li>\n                </ul>\n                <ul class=\"nav navbar-nav navbar-right\">\n                    <li>\n                        <a routerLink=\"/dashboard/dashboard\" routerLinkActive=\"active fluffy\">\n                            <span class=\"glyphicon glyphicon-pencil\"></span> Admin</a>\n                    </li>\n                </ul>\n            </div>\n        -->\n    \n    \n        </div>\n    </nav>\n\n<div class=\"row\">\n  <div class=\"container\">\n  <div class=\"container col-lg-3 col-md-4 col-sm-6\"  *ngFor=\"let item of goodsArray\" >\n    <div class=\"thumbnail\">\n      <img src={{item.thumb_img}} alt=\"...\">\n        <div class=\"caption\">\n            <h3 class=\"caption_h3\">{{item.goods_name}}</h3>\n            <!-- <p>Market Price: <s>{{item.market_price | currency:'USD':true}}</s></p> -->\n            <p>Shop Price (NAS) :  {{item.shop_price}}</p>\n            <p>\n              <!-- <a routerLink=\"/detail/detail/{{item.goods_id}}\" class=\"btn btn-primary\" role=\"button\" >Details</a> -->\n\n          <!--\n          <a href=\"#\" class=\"btn btn-default\" role=\"button\">Add to Cart</a>\n          -->\n\n          <a routerLink=\"/cart/{{item.goods_id}}/{{item.goods_name}}/{{item.shop_price}}\" class=\"btn btn-success\" role=\"button\">Add to Cart</a>\n        </p>\n      </div>\n    </div>\n  </div>\n</div>\n</div>"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _dataClass_defineClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../dataClass/defineClass */ "./src/app/dataClass/defineClass.ts");
...
/* harmony import */ var _services_remote_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/remote.service */ "./src/app/services/remote.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TypePageComponent = /** @class */ (function () {
    function TypePageComponent(goodsService, remoteService) {
        this.goodsService = goodsService;
        this.remoteService = remoteService;
    }
    ...
    TypePageComponent.prototype.getHeroes = function () {
        var _this = this;
        this.goodsService.getGoods()
            .subscribe(function (goodsArray) { return _this.goodsArray = goodsArray; });
        //.then(goodsArray => this.goodsArray = goodsArray)
        //.then(goodsArray => console.log(goodsArray));
    };
    TypePageComponent.prototype.getGoodsByID = function (id) {
        var _this = this;
        this.goodsService.getGood(id)
            .subscribe(function (goodsArray) { return _this.oneGoods = goodsArray; });
    };
    TypePageComponent.prototype.add = function (name) {
        var _this = this;
        name = name.trim();
        if (!name) {
            return;
        ...
        // ?????
        this.goodsService.addGoods(new _dataClass_defineClass__WEBPACK_IMPORTED_MODULE_1__["Goods"](111, 11, 1, 'ECS000001', 1, 'iPhone 6s', 69.99, 869.60, 127, 6, 1.2, '', 'iPhone 6s 4.7-inch display', './app/imgs/iphone6s-silver-select.png', './app/imgs/6s-1.jpeg', './app/imgs/6s-3.jpeg', true, true, true, true, true, new Date('October 13, 2015 11:13:00'), new Date('October 15, 2016 11:13:00')))
            .subscribe(function (hero) {
            _this.goodsArray.push(hero);
        });
    };
    TypePageComponent.prototype.delete = function (hero) {
        this.goodsArray = this.goodsArray.filter(function (h) { return h !== hero; });
    ...
    TypePageComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_goods_service__WEBPACK_IMPORTED_MODULE_2__["GoodsService"],
            _services_remote_service__WEBPACK_IMPORTED_MODULE_3__["RemoteService"]])
    ], TypePageComponent);
...
module.exports = __webpack_require__(/*! /Users/mingjing/Desktop/nas-shop/src/main.ts */"./src/main.ts");
